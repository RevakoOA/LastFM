...
import com.just_me.just_we.lastfmclient.core.exception.NotImplemented
...
@Inject constructor(private val artistsRepository: ArtistsRepository) : UseCase<Artist, GetArtistDetails.Params>() {

    override suspend fun run(params: Params) = artistsRepository.artistDetails(params.name)
