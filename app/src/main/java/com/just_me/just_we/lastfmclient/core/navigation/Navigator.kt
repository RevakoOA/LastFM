 ...
 */
package com.just_me.just_we.lastfmclient.core.navigation
...
import com.just_me.just_we.lastfmclient.features.login.Authenticator
import com.just_me.just_we.lastfmclient.features.login.LoginActivity
...
import com.just_me.just_we.lastfmclient.core.extension.empty
...
@Inject constructor(private val authenticator: Authenticator) {
    ...
    fun showMain(context: Context) {
        when (authenticator.userLoggedIn()) {
            true -> showArtists(context)
            false -> showLogin(context)
        }
    }

    private fun showArtists(context: Context) = context.startActivity(ArtistsActivity.callingIntent(context))

    fun showArtistDetails(activity: FragmentActivity, artist: ArtistPosterModel, navigationExtras: Extras) {
        val intent = ArtistDetailsActivity.callingIntent(activity, artist)
